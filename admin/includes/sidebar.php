<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark " id="sidenavAccordion" style="background-color: #4e73df; color: #ffffff;">
        ...
        <div class="sb-sidenav-footer" style="background-color: #4e73df; color: #ffffff;" >
        </div>
    </nav>
</div>